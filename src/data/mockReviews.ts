...
export const dbMockReviews: AuditionReview[] = [
  // --- HORN ---
  {
    ...
    logistics: { screenUsedTransparency: true, feedbackGiven: true, feedbackTiming: 'After first round', warmUpRoom: true, warmUpType: 'individual', preStageRoom: true, called10MinBefore: true, screenUsedLogistics: true, numberOfRounds: 3 }
  },
  {
  ...
  },
  {
    ...
    logistics: { screenUsedTransparency: false, feedbackGiven: true, feedbackTiming: 'After the audition', warmUpRoom: true, warmUpType: 'individual', preStageRoom: true, called10MinBefore: true, screenUsedLogistics: false, numberOfRounds: 3 }
  },
  ...
  },
  {
    ...
    logistics: { screenUsedTransparency: false, feedbackGiven: true, feedbackTiming: 'By email', warmUpRoom: true, warmUpType: 'individual', preStageRoom: true, called10MinBefore: true, screenUsedLogistics: false, numberOfRounds: 3 }
  },
  {
