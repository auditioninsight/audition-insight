...
export const dbMockReviews: AuditionReview[] = [
  // --- HORN ---
  {
    ...
    logistics: { screenUsedTransparency: true, feedbackGiven: true, feedbackTiming: 'After first round', invitationReceived: true, invitationTiming: 'About one month before', warmUpRoom: true, warmUpType: 'individual', preStageRoom: true, called10MinBefore: true, screenUsedLogistics: true, numberOfRounds: 3 }
  },
  {
    ...
    logistics: { screenUsedTransparency: true, feedbackGiven: false, invitationReceived: true, invitationTiming: 'Less than 2 weeks before', warmUpRoom: true, warmUpType: 'shared', preStageRoom: false, called10MinBefore: true, screenUsedLogistics: true, numberOfRounds: 2 }
  },
  {
    ...
    logistics: { screenUsedTransparency: false, feedbackGiven: true, feedbackTiming: 'After the audition', invitationReceived: true, invitationTiming: 'Between 2 weeks and 1 month', warmUpRoom: true, warmUpType: 'individual', preStageRoom: true, called10MinBefore: true, screenUsedLogistics: false, numberOfRounds: 3 }
  },
  ...
  // --- VIOLIN ---
  {
    ...
    logistics: { screenUsedTransparency: true, feedbackGiven: false, invitationReceived: false, warmUpRoom: true, warmUpType: 'individual', preStageRoom: true, called10MinBefore: true, screenUsedLogistics: true, numberOfRounds: 4 }
  },
  {
    ...
    logistics: { screenUsedTransparency: false, feedbackGiven: true, feedbackTiming: 'By email', invitationReceived: true, invitationTiming: 'More than one month before', warmUpRoom: true, warmUpType: 'individual', preStageRoom: true, called10MinBefore: true, screenUsedLogistics: false, numberOfRounds: 3 }
  },
  {
    ...
    logistics: { screenUsedTransparency: true, feedbackGiven: false, invitationReceived: false, warmUpRoom: false, warmUpType: 'none', preStageRoom: false, called10MinBefore: false, screenUsedLogistics: true, numberOfRounds: 1 }
  },
  ...
  // --- CELLO ---
  {
    ...
    logistics: { screenUsedTransparency: false, feedbackGiven: false, invitationReceived: true, invitationTiming: 'Between 2 weeks and 1 month', warmUpRoom: true, warmUpType: 'shared', preStageRoom: true, called10MinBefore: false, screenUsedLogistics: false, numberOfRounds: 3 }
  },
  {
    ...
    logistics: { screenUsedTransparency: false, feedbackGiven: false, invitationReceived: false, warmUpRoom: false, warmUpType: 'none', preStageRoom: false, called10MinBefore: false, screenUsedLogistics: false, numberOfRounds: 1 }
  }
];
